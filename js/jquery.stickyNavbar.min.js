 ...
 * Original jquery-browser code Copyleft 2005, 2014 jQuery Foundation, Inc. and other contributors
      ...
      this.each(function () {
        {
          ...
          e.find("li a[href*=#]"), s(i).scrollTop();
        }
        m.click(function (i) {
          var o, r, l, c, m;
          if (
            ...
            "http" === o.substring(0, 4) ||
              "https" === o.substring(0, 5) ||
              "mailto:" === o.substring(0, 7) ||
              "/" === o.substring(0, 1))
          )
            return !0;
          for (
            i.preventDefault(), r = o.substr(1), m = n.length, c = {}, l = 0;
            m > l;
            l++
          )
            c[n[l].id] = n[l].offsetTop;
        ...
        var u = function () {
          var u = s(i),
            ...
            p = u.width(),
            C = u.height();
          if (!a.mobile && p < a.mobileWidth) return void e.css("position", o);
          if (
            (m.removeClass(a.activeClass),
            n.each(function () {
              var i = s(this).offset().top - d,
                t = s(this).outerHeight(!0) + i;
              f >= i &&
                t >= f &&
                ("a" === a.selector
                  ? e
            ...
            f >= l + a.startAt
              ? (e
                  .removeClass(a.unstickyModeClass)
                  .addClass(" " + a.stickyModeClass),
                e.css({ position: "fixed", zIndex: a.zindex }).stop(),
                a.jqueryEffects
                  ? (a.animateCSSRepeat ||
                  ...
                  ? a.animateCSSRepeat
                    ? e
                        .addClass(a.cssAnimation + " animated")
                        .one(
                  ...
                  : e.stop())
              : e
                  .css({ position: o, zIndex: r })
                  .removeClass(a.stickyModeClass)
                  .addClass(" " + a.unstickyModeClass),
            "undefined" != typeof h)
          ) {
            var h = n.last(),
              v = h.offset().top + h.outerHeight(!0);
            u.scrollTop() + C >= s(t).height() &&
              v >= f &&
              ...
              l - 2 >= f &&
                ...
                a.jqueryEffects
                  ? (0 === f && m.removeClass(a.activeClass),
                    f >= l
                      ? e
                          .css({ position: "fixed", zIndex: a.zindex })
                          .hide()
                          .stop()
                          [a.jqueryAnim](a.animDuration, a.easing)
                      : e.css({ position: o, zIndex: a.zindex }))
                  : (0 === f && m.removeClass(a.activeClass),
                    e
                      .css({ position: o, top: c })
                      .stop()
                      .animate({ top: c }, a.animDuration, a.easing)));
          }
        };
