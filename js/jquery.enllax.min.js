/* jQuery.enllax.js - v1.1.0 | copyleft 2015, MMK Jony | https://github.com/mmkjony/enllax.js | released under the MIT license */
!(function (t) {
  "use strict";
  t.fn.enllax = function (r) {
    ...
    e.each(function () {
      ...
      "background" == e
        ? "vertical" == s
          ? i.css({ "background-position": "left " + -f + "px" })
          : "horizontal" == s &&
            i.css({ "background-position": -f + "px left" })
        : "foreground" == e &&
          ("vertical" == s
            ? i.css({
