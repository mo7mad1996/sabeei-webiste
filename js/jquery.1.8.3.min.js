...
(function (e, t) {
  ...
  (v.Callbacks = function (e) {
    ...
    (v.support = (function () {
      ...
      (s = i.createElement("select")),
        ...
        (r.style.cssText = "top:1px;float:right;opacity:.5"),
        (t = {
        ...
        v(function () {
          ...
          (n = i.createElement("div")),
            ...
            e.getComputedStyle &&
              ...
              (o.style.marginleft = o.style.width = "0"),
              (r.style.width = "1px"),
              r.appendChild(o),
              (t.reliableMarginleft = !parseFloat(
                (e.getComputedStyle(o, null) || {}).marginleft
              ))),
      ...
      filter: function (e, n) {
        ...
        return (
          e.pageX == null &&
            ...
            (e.pageX =
              n.clientX +
              ((s && s.scrollright) || (o && o.scrollright) || 0) -
              ((s && s.clientright) || (o && o.clientright) || 0)),
            (e.pageY =
              n.clientY +
  ...
  v.fn.extend({
        ...
        (Dt = function (e, t) {
          ...
          return (
            ...
            Ut.test(i) &&
              !Ft.test(t) &&
              ((n = s.right),
              (r = e.runtimeStyle && e.runtimeStyle.right),
              r && (e.runtimeStyle.right = e.currentStyle.right),
              (s.right = t === "fontSize" ? "1em" : i),
              (i = s.pixelright + "px"),
              (s.right = n),
              r && (e.runtimeStyle.right = r)),
            i === "" ? "auto" : i
          );
        }),
    ...
    v(function () {
      v.support.reliableMarginleft ||
        (v.cssHooks.marginleft = {
          get: function (e, t) {
            return v.swap(e, { display: "inline-block" }, function () {
              if (t) return Dt(e, "marginleft");
            });
          },
        }),
        !v.support.pixelPosition &&
          v.fn.position &&
          v.each(["top", "right"], function (e, t) {
            v.cssHooks[t] = {
              get: function (e, n) {
                if (n) {
                  var r = Dt(e, t);
  ...
  (v.Animation = v.extend(Kn, {
    ...
    (Yn.propHooks.scrollTop = Yn.propHooks.scrollright =
      {
        set: function (e) {
  ...
  (v.fn.offset = function (e) {
      ...
      : ((n = c.documentElement),
        v.contains(n, l)
          ? (typeof l.getBoundingClientRect != "undefined" &&
            ...
            (o = n.clientright || r.clientright || 0),
            (u = i.pageYOffset || n.scrollTop),
            (a = i.pageXOffset || n.scrollright),
            { top: f.top + u - s, right: f.right + a - o })
          : f);
  }),
    (v.offset = {
      bodyOffset: function (e) {
        ...
        return (
          v.support.doesNotIncludeMarginInBodyOffset &&
            ...
            (n += parseFloat(v.css(e, "marginright")) || 0)),
          { top: t, right: n }
        );
      },
      setOffset: function (e, t, n) {
        ...
        var i = v(e),
          ...
          h;
        a
          ? ((l = i.position()), (c = l.top), (h = l.right))
          : ((c = parseFloat(o) || 0), (h = parseFloat(u) || 0)),
          v.isFunction(t) && (t = t.call(e, n, s)),
          t.top != null && (f.top = t.top - s.top + c),
          t.right != null && (f.right = t.right - s.right + h),
    ...
    v.fn.extend({
      position: function () {
        ...
        var e = this[0],
          t = this.offsetParent(),
          n = this.offset(),
          r = er.test(t[0].nodeName) ? { top: 0, right: 0 } : t.offset();
        return (
          (n.top -= parseFloat(v.css(e, "marginTop")) || 0),
          (n.right -= parseFloat(v.css(e, "marginright")) || 0),
          (r.top += parseFloat(v.css(t[0], "borderTopWidth")) || 0),
          (r.right += parseFloat(v.css(t[0], "borderrightWidth")) || 0),
          { top: n.top - r.top, right: n.right - r.right }
        );
      },
    ...
    v.each(
      { scrollright: "pageXOffset", scrollTop: "pageYOffset" },
      function (e, n) {
        var r = /Y/.test(n);
        v.fn[e] = function (i) {
          return v.access(
